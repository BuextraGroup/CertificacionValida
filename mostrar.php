...
$mostrar = "SELECT * from certificado";
    ...
    <table class="table table-bordered border-secondary" style="text-align: center; margin-top: 40px">
      <thead class="table-dark">
        <tr>
            ...
            <th><b><font >Tipo de certificado</font></b></th>
      ...
      <tbody>
        ...
        ?>
            <tr>
                <th><?php echo $row['cer_nombre']?></th>
                <th><?php echo $row['cer_folio']?></th>
                <th><?php echo $row['cer_tipo']?></th>
                <th><?php echo $row['cer_fecha_certificacion']?></th>
                <th><?php echo $row['cer_vigencia']?></th>
            </tr>
          <?php
              }
            ?>
