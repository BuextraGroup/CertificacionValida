...
$insertar = "INSERT into certificado (cer_nombre, cer_folio, cer_tipo, cer_fecha_certificacion, cer_vigencia)values('$nombre', '$folio', '$certificacion', '$fcertificacion', '$fecha')";
...
echo "<b>Certificación: </b>" . $certificacion . "<br/>";
